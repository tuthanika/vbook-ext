...
function execute(url) {
    ...
    // "https://shop.vietstarhp.com/api/" + site + "/chap.php?q=" + e.url + "&k=" + book_id
    let response_chapter_info = fetch("https://shop.vietstarhp.com/api/" + site + "/chap.php?q=" + chap_id + "&k=" + book_id)
